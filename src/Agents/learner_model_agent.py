...
class LearnerModelAgent(MyConversableAgent):
    description = """I am a diligent and meticulous learning tracker. I assess the Student's educational journey, adapting learning paths by collaborating with the Tutor and Knowledge Tracer. I analyze performance data to provide feedback, help set educational goals, and adjust the difficulty of tasks. I ensure that the learning experience is tailored to the Student’s evolving capabilities and needs."""
